...
3.	The cross-domain transmission are performed in gray code instead of binary to increase its robustness.


4.	1 extra MSB is added to the r_ptr and w_ptr to differentiate full_flag and empty_flag with the following code:  
